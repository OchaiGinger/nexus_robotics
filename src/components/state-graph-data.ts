...
export const STATE_GRAPH: GraphNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      // delegator.updateActionsTable removed — completion is written by
      // the validator API before the machine returns to nextAction.
...
export const EDGES: GraphEdge[] = [
  ...
  // director: atomize once per batch, then bulk-create Action rows
  {
    id: "e25",
  ...
  },
  {
    ...
    from: "nextAction",
    to: "orchestrator",
    label: "isAllActionsDone",
    kind: "loop",
  },
  { id: "e29", from: "updateActionPending", to: "delegator.cameraPosition", label: "onDone" },
